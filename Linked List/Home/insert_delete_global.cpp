...
void options()
{
    ...
    cout<<"Input 4 to insert in a sorted way"<<endl; //remember list need to be empty on first operation
...
void insert_in_sorted_way(int num)
{
    int i,info;
...
int main()
{
    ...
    while(1){
        ...
        if(indicate==1){
            ...
            cout<<"how many nodes"<<endl;
            cin>>desired_num;
            insert_in_sorted_way(desired_num);
        }
        else if(indicate==5){
            show();
        }
